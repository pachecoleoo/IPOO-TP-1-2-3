...
class Punto{
    ...
    public function  __construct($x, $y){ //fabrica, donde salen los objetos. 
		// Metodo constructor de la clase Punto (array asociativo)
		$this->coordenada_x = $x;
		$this->coordenada_y = $y; // this es una referencia hacia el objeto conectado con el atributo 
